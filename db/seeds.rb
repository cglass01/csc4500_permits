...
User.create!(email: 'emailcrusher@email.com', password: 'passpass', created_at: '2015-02-3 10:54:35', updated_at: '2015-02-3 10:54:35', roles: 'Editor', position: 'Student')
user1 = User.create!(email: 'newsmaker@email.com', password: 'slampass', created_at: '2015-04-3 12:54:35', updated_at: '2015-12-3 10:54:35', roles: 'Editor', position: 'Student')
user2 = User.create!(email: 'studenthome@email.com', password: 'learner', created_at: '2016-05-25 10:00:35', updated_at: '2016-06-20 11:44:35',roles: 'Standard', position: 'Student')
user3 = User.create!(email: 'teacherwork@email.com', password: 'study6', created_at: '2012-08-25 12:05:35', updated_at: '2017-08-25 11:44:35', roles: 'Standard',position: 'Faculty')
user4 = User.create!(email: 'superadmin@email.com', password: 'admin6', created_at: '2012-08-25 12:05:35', updated_at: '2017-08-25 11:44:35', roles: 'Standard',position: 'Student')
user5 = User.create!(email: 'editmon@email.com', password: 'editor', created_at: '2012-08-25 12:05:35', updated_at: '2017-08-25 11:44:35', roles: 'Standard',position: 'Faculty')
...
user6 = User.create!(email: 'studenttwo@email.com', password: 'learner', created_at: '2016-05-25 10:00:35', updated_at: '2016-06-20 11:44:35',roles: 'Editor', position: 'Student')
...
user8 = User.create!(email: 'curlymoe@email.com', password: 'threehead', created_at: '2017-02-01 10:00:00', updated_at: '2017-06-20 10:04:00', roles: 'Admin', position: 'Faculty')
user9 = User.create!(email: 'moelarry@email.com', password: 'headthree', created_at: '2014-03-01 10:00:00', updated_at: '2017-06-20 10:04:00', roles: 'Editor', position: 'Faculty')
user10 = User.create!(email: 'larrycurly@email.com', password: 'bonehead', created_at: '2015-04-01 10:00:00', updated_at: '2017-06-20 10:04:00', roles: 'Admin', position: 'Faculty')
...
user11 = User.create!(email: 'studentschool@email.com', password: 'sporty', created_at: '2016-05-25 10:00:35', updated_at: '2016-06-20 11:44:35', roles: 'Standard', position: 'Student')
user12 = User.create!(email: 'studentapart@email.com', password: 'loonytune', created_at: '2016-05-25 11:00:35', updated_at: '2016-05-20 11:44:35', roles: 'Standard', position: 'Student')
user13 = User.create!(email: 'studentstudio@email.com', password: 'cheezit', created_at: '2016-05-25 12:00:35', updated_at: '2016-07-20 11:44:35', roles: 'Standard', position: 'Student')
...
vh3 = Vehicle.create(year: '2010', color: 'Orange', make: 'BMW', model: 'X3', license_number: 'G53684554', state_licensed: 'IL',
...
vh4 = Vehicle.create(year: '2003', color: 'Purple', make: 'Honda', model: 'Accord', license_number: 'V45865848', state_licensed: 'DE',
...
vh5 = Vehicle.create(year: '2016', color: 'White', make: 'Chevrolest', model: 'Traverse', license_number: 'P45864869', state_licensed: 'WY',
